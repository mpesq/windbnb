...
function ButtonInputGroupBig()  {
  ...
  return (
    <div className="ButtonInputGroupBig-container">
      <input
        className="ButtonInputGroupBig-container-input-location"
        type="text"
      ...
      />
      <input
        className="ButtonInputGroupBig-container-input-guests"
        type="text"
        value={inputGuestsValue}
        placeholder="Guests"
        onChange={handleInputGuestsChange}
      />
      <button>
        <svg
...
export default ButtonInputGroupBig;
